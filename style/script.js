...
const musicBtn = document.getElementById("music-btn");
  ...
  // **LOGIC CHUYỂN HƯỚNG MỚI ĐÃ CẬP NHẬT**
  closePopupBtn.addEventListener("click", () => {
    // URL chuyển hướng mới
    const targetURL = "https://taoanhdep.com/love/?b=eyJ0IjpbIk5n4buNYyBUaGFuaCIsIlNpbmggbmjhuq10IiwiVnVpIHbhursiXSwiYSI6ImhnZWRhdCJ9";
    
    // Chuyển hướng trang trong tab hiện tại
    window.location.href = targetURL;
    
    // Các lệnh bên dưới sẽ không được thực thi do trang đã chuyển hướng
...
// Loại bỏ logic cũ của closePopupBtn đã được thay thế ở trên
// closePopupBtn.addEventListener("click", () => {
//   popup.classList.remove("show");
//   stopFireworks();
//   moveCount = 0; 
